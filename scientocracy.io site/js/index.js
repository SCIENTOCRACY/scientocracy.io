...
for (i = 0; i < totalObjects; i++) {var vertex = new THREE.Vector3();
...
var material = new THREE.ParticleBasicMaterial({size: 500});
...
container.appendChild(renderer.domElement);
 ...
 function updatePlane() { for (var i = 0; i < plane.geometry.vertices.length; i++)
   { 
